...
async def run_agents(request: Request):
    try:
        ...
        # If no code is supplied, generate it with AI
        if not screen_code:
            screen_code = generate_code(feature, target)

        # Save Flutter UI component
        save_flutter_feature(
            project=project,
        ...
        return {
            ...
            "project": project,
            "feature": feature,
            "generated_code": screen_code[:1000],  # optional preview
